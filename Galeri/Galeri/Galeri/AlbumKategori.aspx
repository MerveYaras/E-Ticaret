<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AlbumKategori.aspx.cs" Inherits="Galeri.AlbumKategori" %>
...
<html>
    ...
    <body>
		...
		<div class="header">
			<h1>3d Wall Gallery</h1>
			<div id="pg_scrollWrapper" class="pg_scrollWrapper">
				<div id="slider" class="slider"></div>
			</div>
			<a class="reference" href="http://www.flickr.com/photos/alanant/" target="_blank">Photography by Alan Antiporda</a>
		</div>
		<div class="wall">
			<div id="pg_container" class="pg_container">
				<ul id="pg_photos" runat="server" class="pg_photos"><!-- calculate top-->
		...
		<div class="footer">
			<a class="back left" href="http://tympanus.net/Tutorials/ThumbnailsPreviewSlider/">Previous Demo: <strong>Thumbnails Preview Slider</strong></a>
			<div class="thumbnailSlider" id="thumbnailSlider">
				<ul class="ts_container" id="resim" runat="server">
					
					
					
				</ul>
			</div>
			<a class="back right" href="http://tympanus.net/codrops/2011/02/02/3d-wall-gallery/">back to the Codrops article</a>
