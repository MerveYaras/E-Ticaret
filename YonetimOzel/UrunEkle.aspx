<%@ Page Title="" Language="C#" MasterPageFile="~/YonetimOzel/YonetimOzel.Master" AutoEventWireup="true" CodeBehind="UrunEkle.aspx.cs" Inherits="e_ticaret.UrunEkle" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <tr>
        <td style="font-size: x-small">
            İçerik</td>
        <td>
            <cc1:Editor ID="Editor1" runat="server" Height="350px" Width="500px" />
        </td>
        <td>
            &nbsp;</td>
    </tr>
