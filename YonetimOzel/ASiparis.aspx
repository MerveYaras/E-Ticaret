<%@ Page Title="" Language="C#" MasterPageFile="~/YonetimOzel/YonetimOzel.Master" AutoEventWireup="true" CodeBehind="ASiparis.aspx.cs" Inherits="e_ticaret.ASiparis" %>
        ...
        <tr>
            <td colspan="3">
                ...
                <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" 
                    ...
                    <tr>
                        <td style="font-size: x-small">
                            <strong>Kargo Bilgisi</strong></td>
                        <td>
                            <asp:DropDownList ID="DropDownList1" runat="server" Height="26px" Width="153px">
                    ...
                    <tr>
                        <td style="font-size: x-small">
                            &nbsp;</td>
                        <td>
                            <asp:Button ID="Button1" runat="server" Text="Siparişi Tamamla" 
