        ...
        $('#jqfnumkeypad_' + instance.attr('name')).fadeIn(options.fadeSpeed, function() {
          ...
          if(instance.attr('maxlength') == -1 || instance.val().length < instance.attr('maxlength')) instance.val(instance.val() + parseFloat($(this).html()));
                if(instance.val().length == 4)
        			{
        				if(instance.attr('name') == 'KartNo1') $('#KartNo2').focus();
        				if(instance.attr('name') == 'KartNo2') $('#KartNo3').focus();
        				if(instance.attr('name') == 'KartNo3') $('#KartNo4').focus();
                        if(instance.attr('name') == 'KartNo4'){ $('#CCV').focus(); $('.jqfnumkeypad').hide(); }
        			}
            e.stopPropagation();
          });
          // Clear click
